...
monBouton.addEventListener("click", ()=>{
    ...
    // si c'est le cas, on accepte pas sa phrase, et on la remplace par
    ...
    let containsTarget= lesMots.includes("quiche")
        if (containsTarget){
            laPhrase = "désolé quiche n'est pas un mot autorisé"
            monChampTexte.value = "oups ce mot est interdit"
        }
        else (containsTarget)
    {
        monChampTexte.value = "bien vu le couz"
    }
